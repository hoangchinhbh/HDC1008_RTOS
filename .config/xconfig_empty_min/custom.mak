...
linker.cmd: package/cfg/empty_min_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_min_pem4fcfg.cmd\)\"$""\"C:/Users/Eric/Documents/GitHub/Senior-Design/HDC1008_RTOS/.config/xconfig_empty_min/\1\""' package/cfg/empty_min_pem4f.xdl > $@
